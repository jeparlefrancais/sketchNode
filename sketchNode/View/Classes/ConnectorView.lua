...
function class.New(o, parent, typedVariableOrArgument)
	parent, typedVariableOrArgument = class.Package.Utils.Tests.GetArguments(
		{'Instance', parent}, -- The parent component.
		{'TypedVariable', typedVariableOrArgument}  -- The argument component.
	)
	...
	local container = class.Package.Templates.Container{
		...
		class.Package.Templates.MinimalText(typedVariableOrArgument:GetType(), {
			...
			Text = typedVariableOrArgument:GetType(),
...
function class:SetSize(isRight)
	isRight = class.Package.Utils.Tests.GetArguments(
		{'boolean', isRight}
	)
end
...
function class:SetConnected(linked)
	...
	self.connectorView.ConnectorStroke.Connector.ImageColor3 = linked and Color3.fromRGB(112, 112, 112) or GetConnectorColor(self.typedVariable)
end
